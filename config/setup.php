...
const CAPTIONS = [
    ...
    15 => "Luxury isn't measured by palm trees or turquoise water. It's found in these suspended moments where time slows down, where the sun sets exactly as it should. No rush, no compromise. Just the perfect balance between what you've built and what you allow yourself to experience. The ambient lighting, the silhouettes in the water, the circular bar waiting—all of it is the result of choices. Sacrifices no one sees, hours when you could have given up but held strong. This setting isn't an accident, it's a reward. And within this apparent peace lies a simple truth: you're not here by luck, you're here because you refused mediocrity. The calm of this scene reflects the storm you've weathered to reach it. Some people dream of these moments. You create them."
];
