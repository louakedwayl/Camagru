    ...
    <?php require_once __DIR__ . '/visitor_navbar.php'; ?>
        ...
        <div class="post-container">
            ...
            <div class="post-header post-header-mobile">
                ...
                <a href="index.php?action=visitor_profile&username=<?= htmlspecialchars($post['username']) ?>" class="post-username"><?= htmlspecialchars($post['username']) ?></a>
            ...
            <div class="post-details-side">
                ...
                <div class="post-comments-section">
                    ...
                    <div class="comment-item">
                        ...
                        <div class="comment-content">
                            <a href="index.php?action=visitor_profile&username=<?= htmlspecialchars($post['username']) ?>" class="comment-username"><?= htmlspecialchars($post['username']) ?></a>
                    ...
                    <div class="comment-item">
                        ...
                        <div class="comment-content">
                            <a href="index.php?action=visitor_profile&username=<?= htmlspecialchars($comment['username']) ?>" class="comment-username"><?= htmlspecialchars($comment['username']) ?></a>
                ...
                <!-- LOGIN PROMPT instead of comment input -->
                <div class="post-add-comment">
                    <a href="index.php" class="login-prompt-comment">Log in to like or comment</a>
                </div>
            </div>
        </div>
    </main>
