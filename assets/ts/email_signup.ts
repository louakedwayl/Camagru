(() => {
    ...
    const input = document.querySelector<HTMLInputElement>("main form input")!;
    const resendLink = document.getElementById("resend-link");
    const snackbarPErrorSuccess = document.querySelector<HTMLElement>("#snackbar-success")!;
    const snackbarPErrorFailure = document.querySelector<HTMLElement>("#snackbar-failure")!;

    const snackbar = document.querySelector<HTMLElement>(".snackbar")!;
    const errorContainer = document.querySelector<HTMLElement>("div.error");
    const pErrorInvalid = document.querySelector<HTMLElement>("p.error")!;
    const pErrorTimeout = document.querySelector<HTMLElement>("p.error2")!;
    ...
    function showSnackbar(type: 'success' | 'error') {
