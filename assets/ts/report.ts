(() => {
    ...
    if (reportModal) {
        const reportForm = reportModal.querySelector<HTMLFormElement>('form')!;
        const reportTextarea = reportForm.querySelector<HTMLTextAreaElement>('textarea.report')!;
        const reportSendBtn = reportForm.querySelector<HTMLButtonElement>('button.report.send')!;
        const crossModale = reportModal.querySelector<HTMLAnchorElement>('a.modale.cross')!;
