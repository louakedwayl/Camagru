...
(() => {
    ...
    const emailInput = document.querySelector<HTMLInputElement>('main input[name="email"]')!;
    const passwordInput = document.querySelector<HTMLInputElement>('main input[name="password"]')!;
    const fullnameInput = document.querySelector<HTMLInputElement>('main input[name="fullname"]')!;
    const usernameInput = document.querySelector<HTMLInputElement>('main input[name="username"]')!;
    const form = document.querySelector<HTMLFormElement>('main form')!;
    const submitBtn = form.querySelector<HTMLButtonElement>('button[type="submit"]')!;

    // Sélecteurs d'erreurs
    const pErrorEmail = document.querySelector<HTMLParagraphElement>(".top p.error.email")!;
    const pErrorEmailInvailable = document.querySelector<HTMLParagraphElement>(".top p.error.email_invailable")!;
    const pErrorPassword = document.querySelector<HTMLParagraphElement>(".top p.error.password")!;
    const pErrorPasswordUpercase = document.querySelector<HTMLParagraphElement>(".top p.error.uppercase")!;
    const pErrorFullname = document.querySelector<HTMLParagraphElement>(".top p.error.fullname")!;
    const pErrorFullnameSize = document.querySelector<HTMLParagraphElement>(".top p.error.fullname_size")!;
    const pErrorUsernameSize = document.querySelector<HTMLParagraphElement>(".top p.error.username_size")!;
    const pErrorUsername = document.querySelector<HTMLParagraphElement>(".top p.error.username")!;
    const pErrorUsernameInvailable = document.querySelector<HTMLParagraphElement>(".top p.error.username_invailable")!;
