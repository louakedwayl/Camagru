...
(() => {
    ...
    function loadNotifications() {
        fetch('index.php?action=get_notifications')
            .then(res => res.json())
            .then((data: GetNotificationsResponse) => {
     ...
     */
    function createNotificationItem(notif: NotificationItem): HTMLAnchorElement {
    ...
    Object.assign(window, { toggleNotificationBar, closeNotificationBar });
})();
