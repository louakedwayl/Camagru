...
(() => {
    ...
    const commentInput = document.querySelector<HTMLTextAreaElement>('.comment-input');



    const commentSubmit = document.querySelector<HTMLButtonElement>('.comment-submit');
    ...
    // Like / Unlike
    const iconLike = document.querySelector<HTMLImageElement>('.icon-like');
    if (iconLike) {
    ...
    const threeDots = document.querySelectorAll<HTMLImageElement>('.three-dots');
    ...
    if (modal) {
        ...
        if (deleteBtn) {
            deleteBtn.addEventListener('click', async () => {
                ...
                const postId = document.querySelector<HTMLImageElement>('.three-dots')!.dataset.postId!;
