(() => {
    ...
    const editFullnameInput = document.querySelector<HTMLInputElement>('#edit-fullname')!;
    const editUsernameInput = document.querySelector<HTMLInputElement>('#edit-username')!;
    const editEmailInput = document.querySelector<HTMLInputElement>('#edit-email')!;
    const editPasswordInput = document.querySelector<HTMLInputElement>('#edit-password')!;
    const editPasswordConfirmInput = document.querySelector<HTMLInputElement>('#edit-password-confirm')!;
    const editForm = document.querySelector<HTMLFormElement>('#edit-profile-form')!;
    const submitBtn = document.querySelector<HTMLButtonElement>('.btn-save-profile')!;

    const pErrorFullnameSize = document.querySelector<HTMLParagraphElement>(".error-edit.fullname_size");
    const pErrorFullname = document.querySelector<HTMLParagraphElement>(".error-edit.fullname");
    const pErrorUsernameSize = document.querySelector<HTMLParagraphElement>(".error-edit.username_size");
    const pErrorUsername = document.querySelector<HTMLParagraphElement>(".error-edit.username");
    const pErrorUsernameUnavailable = document.querySelector<HTMLParagraphElement>(".error-edit.username_unavailable");
    const pErrorEmail = document.querySelector<HTMLParagraphElement>(".error-edit.email");
    const pErrorEmailUnavailable = document.querySelector<HTMLParagraphElement>(".error-edit.email_unavailable");
    const pErrorPassword = document.querySelector<HTMLParagraphElement>(".error-edit.password");
    const pErrorPasswordUppercase = document.querySelector<HTMLParagraphElement>(".error-edit.uppercase");
    const pErrorPasswordMatch = document.querySelector<HTMLParagraphElement>(".error-edit.password_match");
    ...
    const modal = document.getElementById('modal-edit-profile') as HTMLDialogElement;
    const btnOpenEdit = document.querySelector<HTMLElement>('.btn-edit-profile')!;
    const btnCloseEdit = document.querySelector<HTMLElement>('.modal-edit-close')!;

    function resetError(input: HTMLInputElement, ...errorElements: (HTMLParagraphElement | null)[]) {
    ...
    function showError(input: HTMLInputElement, errorElement: HTMLParagraphElement | null) {
    ...
    editForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            formData.append('notifications', (document.getElementById('edit-notifications') as HTMLInputElement).checked ? '1' : '0');
